...
function initControls() {
    ...
    const startIterInput = document.getElementById('startIterInput');
    const endIterInput = document.getElementById('endIterInput');
...
function runGumowskiMira(params, startIter = 0, endIter = 20000) {
    const canvas = document.getElementById('canvas');
    const ctx = canvas.getContext('2d');
    clearCanvas();
